...
// 	echo Form::input(["label"=>"Service Charge","type"=>"text","name"=>"service_charge","value"=>"$invoice->service_charge"]);
// 	echo Form::input(["label"=>"Cleaning Charge","type"=>"text","name"=>"cleaning_charge","value"=>"$invoice->cleaning_charge"]);
// 	echo Form::input(["label"=>"Order Id","type"=>"text","name"=>"order_id","value"=>"$invoice->order_id"]);

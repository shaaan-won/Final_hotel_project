...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2024 at 02:30 PM
...
(1, 1, 1, '2024-12-28 00:00:00', '2024-12-30 00:00:00', 5, '2024-12-28 11:34:06', '2024-12-28 11:34:06');
...
(1, 1, '2024-12-28 12:00:00', '2024-12-30 12:00:00', '', '2024-12-28 11:34:06', '2024-12-28 11:34:06');
...
(1, '101', 1, 100.00, 2, 5, '2024-12-28 11:05:45', '2024-12-28 11:34:06'),
...
CREATE TABLE `ht_users` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `photo` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `verify_code` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `inactive` tinyint(1) UNSIGNED DEFAULT 0,
  `mobile` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `ip` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `email_verified_at` datetime DEFAULT NULL,
  `remember_token` varchar(145) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

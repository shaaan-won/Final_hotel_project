...
echo Form::open(["route"=>"invoice/update"]);
	...
	echo Form::input(["label"=>"Room Amenitie","name"=>"room_amenitie_id","table"=>"room_amenities","value"=>"$invoice->room_amenitie_id","display_column"=>"id"]);
...
// 		<!-- Amenities Charges -->
// 		<div style="width: 48%;">
// 			<h3 class="text-center">Amenities Charges</h3>
...
// 					</td>
// 					<td>
// 						<h4 class="text-red bg-secondary fs-24 p-2 rounded">
...
// 		<h4>Total Due: <span id="final-amount-due">$675.00</span></h4>

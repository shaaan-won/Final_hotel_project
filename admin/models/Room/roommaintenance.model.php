...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			$html.="<tr><th>Id</th><th>Room Id</th><th>Description</th><th>Status Id</th><th>Created At</th><th>Updated At</th><th>Action</th></tr>";
		}else{
		...
		while($roommaintenance=$result->fetch_object()){
			...
			$html.="<tr><td>$roommaintenance->id</td><td>$roommaintenance->room_id</td><td>$roommaintenance->description</td><td>$roommaintenance->status_id</td><td>$roommaintenance->created_at</td><td>$roommaintenance->updated_at</td> $action_buttons</tr>";
		}
		$html.="</table>";
